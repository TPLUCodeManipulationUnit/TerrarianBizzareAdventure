...
{
    public sealed class ServerFriendlyAnimation
    {
        private int _ticks;
        ...
        public ServerFriendlyAnimation(string texturePath, int width, int height, int frameCount, int frameSpeed, bool autoLoop = false, SpriteAnimation nextAnimation = null, bool reverseNextAnimation = false)
        {
        ...
        public Vector2 FrameSize => new Vector2(Width, Height / FrameCount);
